...
function demQuery()
{
    ...
    $sqlCmd = <<< sql
            ...
            from aaa_blk_grps, aaa_demographics where aaa_blk_grps."GEOid2" = aaa_demographics."GEOid2" AND race IN($raceParams) AND age_sex_grp IN($ageParams) GROUP BY aaa_blk_grps."GEOid2", aaa_blk_grps.county, tot_dem, tot_inc
sql;

    $test = "select distinct race from aaa_demographics order by race";
